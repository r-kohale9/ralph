...
(function (window) {
  ...
  // setScore / setQuestionLabel are NOT part of the public API
  // (stars-immutable contract). The header is mutated only via:
  //   (1) game_init.data.score / game_init.data.questionLabel — initial baseline
  //   (2) show_star.data.count                                 — increments numerator
  // Validator rules GEN-ACTIONBAR-STARS-IMMUTABLE and
  // GEN-QUESTION-LABEL-IMMUTABLE block any direct calls statically.
