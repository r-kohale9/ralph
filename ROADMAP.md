...
**Last updated:** March 20, 2026 (cross-batch-guard false rollback fix; generation LLM timeout fix 300→600s; M1-M5 mechanics rules; git merge a9d7f7b; R&D: game-flow spec phase hints active)
