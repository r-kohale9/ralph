<!--
  ...
  MISCONCEPTION TARGETED: Students use the wrong ratio (sin when tan is needed) by guessing rather
    than identifying which two sides are known (Syifa & Kurniawati 2026 — 80.95% difficulty rate)
  SOURCE: https://www.researchgate.net/publication/395418861_Student_Error_in_Grade_X_on_the_Concept_of_Trigonometry_Using_a_Hermeneutic_Phenomenological_Study
  ...
  NCERT: Ch 8 §8.1 Ex 8.1 Q2 (tan P − cot R), Q9 (if tan A = 1/√3, find sin A cos C + cos A sin C)
  SESSION ID: trigonometry-class10-20260322-7j6biw
  GENERATED: Phase 5 — Session Planner spec generation, 2026-03-23
-->

# Which Ratio? — Session Variant (Trig Class 10, Game 2 of 5)
...
> **PEDAGOGICAL DESIGN NOTE.** This game implements Bloom's Level 2 (Understand) for the skill `identify-ratio`: given a right triangle with two sides labeled and angle θ marked, the learner must identify WHICH trig function (sin/cos/tan) equals the ratio of those two sides. Session position: Game 2 of 5 — builds on side-labelling (Game 1), prerequisite for computation (Game 3). Target misconception: students selecting the wrong ratio (sin when tan is needed) by mnemonic guessing rather than identifying which two sides are known (Syifa & Kurniawati 2026 — 80.95% difficulty rate; NCERT Ex 8.1 Q2). This is pure definition recall — no computation. The three-button MCQ (sin θ / cos θ / tan θ) forces recall of the SOH-CAH-TOA mnemonic. On the first incorrect attempt, a worked-example panel expands showing the full SOH-CAH-TOA reference card with the correct mapping highlighted. On the second incorrect attempt the game advances to the next round — no lives deducted. The 5 rounds cover all three ratios and include both "given two sides, name the ratio" and "given the ratio name, identify the correct pair of sides" formats. NCERT alignment: Ch 8 §8.1 Ex 8.1 Q2 (tan P − cot R), Q9. Interaction type: `ratio-identification-mcq`.
...
- **Type:** standard
- **Description:** Students identify the correct trig ratio (sin/cos/tan) given a labeled right triangle diagram. 5 rounds covering all three ratios. MCQ interaction: 3 buttons per round. Worked-example panel reveals on first wrong attempt; round skipped on second wrong attempt. No lives deducted — this is a learning-first game. Stars based on first-attempt accuracy. Targets Grade 10 / NCERT Ch 8 §8.1 / CC HSG-SRT.C.6 / Bloom L2 Understand. Addresses misconception: wrong ratio selection (Syifa & Kurniawati 2026). Session position: Game 2 of 5. Prerequisite: name-the-sides (Game 1). Successor: soh-cah-toa-worked-example (Game 3).
