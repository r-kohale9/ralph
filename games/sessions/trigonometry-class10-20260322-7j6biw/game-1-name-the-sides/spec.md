<!--
  ...
  MISCONCEPTION TARGETED: Students treat 'opposite' and 'adjacent' as absolute triangle properties
    rather than angle-relative labels (Msi, Matsepe & Sehowa 2026, Eastern Cape Grade 10 study)
  SOURCE: https://www.researchgate.net/publication/401706057_Errors_in_trigonometric_proof-related_reasoning_tasks_Insights_from_Grade_10_learners_at_a_rural_Eastern_Cape_school
  ...
  NCERT: Ch 8 §8.1 Ex 8.1 Q1 — Find sin A, cos A, sin C, cos C for right triangle with AB=24, BC=7
    (directly tests angle-relative labelling)
  SESSION ID: trigonometry-class10-20260322-7j6biw
  GENERATED: Phase 5 — Session Planner spec generation, 2026-03-23
-->

# Name the Sides — Session Variant (Trig Class 10, Game 1 of 5)
...
> **PEDAGOGICAL DESIGN NOTE.** This game implements Bloom's Level 1 (Remember) for the skill `label-triangle-sides`: given a right triangle with a clearly marked reference angle, the learner recalls which side is the hypotenuse, which is opposite to the angle, and which is adjacent. This is the foundational prerequisite — a learner who cannot label sides cannot select the correct trig ratio. Target misconception: students treating 'opposite' and 'adjacent' as absolute triangle properties rather than angle-relative labels (Msi, Matsepe & Sehowa 2026). The interaction is deliberately non-numeric: no formulas, no calculation, no timer in rounds 1-6. The difficulty progression (standard orientation → rotated → two-angle comparison) forces the learner to reason from the geometric relationship, not memorise a visual pattern. Interaction type: `label-assignment-dropdown`. Session-planner position: Game 1 of 5 in the trig session (prerequisite-ordered). Successor: `which-ratio` (Bloom L2 — ratio identification). NCERT alignment: Ch 8 §8.1 Ex 8.1 Q1.
...
- **Type:** standard
- **Description:** Students identify the hypotenuse, opposite side, and adjacent side of a right triangle relative to a given reference angle. 9 rounds with three difficulty tiers. No lives system — on first incorrect attempt an explanatory panel reveals the correct definition; on second incorrect attempt the round is skipped. No timer in rounds 1-6; optional 20-second timer in rounds 7-9. Targets Grade 10 / NCERT Ch 8 §8.1 / CC HSG-SRT.C.6 / Bloom L1 Remember. Addresses misconception: 'opposite' and 'adjacent' as absolute vs angle-relative labels (Msi, Matsepe & Sehowa 2026). Session position: Game 1 of 5. Prerequisite: none. Successor: which-ratio (Game 2).
