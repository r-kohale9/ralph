...
async function generateSpec(specInstructionsPath, options) {
  ...
  if (templateSpecId) {
    ...
    if (fs.existsSync(templatePath)) {
      ...
      // Template not found — include warning in instructions but proceed
      templateContent = `<!-- Template spec games/${templateSpecId}/spec.md not found on disk — generate a complete spec from the instructions above. -->`;
    }
  }
