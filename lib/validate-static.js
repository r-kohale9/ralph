...
// ─── 5f3. TimerComponent — available in CDN but loads late ───────────────────
// TimerComponent IS in the CDN bundle but loads AFTER ScreenLayout/FeedbackManager.
// Games that reference it before waitForPackages() confirms it is defined get
// "ReferenceError: TimerComponent is not defined". Safe usage requires the
// waitForPackages() loop to include: typeof TimerComponent === 'undefined'.
