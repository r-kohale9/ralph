...
- window.__ralph.setLives/setRoundTimes/endGame "is not a function" → usually indicates the harness didn't inject (page didn't load properly), not that the method doesn't exist. Check if the HTML is broken.
