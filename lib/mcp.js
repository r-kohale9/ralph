      ...
      return {
        content: [{
          ...
          text: [
            ...
            `- 0 Critical/Warning findings → call register_spec with game_id="${game_id}", skip_review=true, and the same spec_content to complete registration.\n`,
            ...
            '- "fix N issues" → fix in the SAME spec artifact (never create a new one), then STOP and wait for "register"\n',
