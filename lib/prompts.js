...
20. ROUND LIFECYCLE RESET — required at the START of every loadRound() / initRound() / setupRound() call:
    ...
    GEN-ISPROCESSING-RESET: If you use an isProcessing flag, it MUST be reset to false:
      ...
      - At the END of nextRound() after all setup is complete
      - On game restart
...
- GEN-ISPROCESSING-RESET: isProcessing MUST be reset to false at end of handleGotIt(), end of nextRound(), and on restart — never leave isProcessing=true across round boundaries. (build #583)
