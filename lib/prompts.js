...
29. RULE-SENTRY-ORDER: initSentry() MUST be called INSIDE the waitForPackages() callback, AFTER packages load:
    initSentry() checks typeof SentryConfig internally and returns early if not defined. However, calling
    initSentry() BEFORE waitForPackages() can race with CDN package initialization — always call it AFTER.
