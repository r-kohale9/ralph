...
- IF spec uses PART-025/ScreenLayout: LAST step of DOMContentLoaded MUST call transitionScreen.show({...}) to show start screen in #mathai-transition-slot — WITHOUT this call the slot is empty and ALL tests timeout on first assertion. restartGame() MUST also call transitionScreen.show().
