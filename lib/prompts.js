...
- GEN ARIA-001 (WCAG SC 4.1.3): all feedback divs (#feedback, .feedback-message, correct-feedback, incorrect-feedback) MUST have aria-live="polite" or aria-live="assertive" — missing aria-live means screen readers never announce feedback
...
30. GEN ARIA-001 (FEEDBACK ACCESSIBILITY — WCAG SC 4.1.3): All dynamic feedback elements that appear/disappear in response to user action MUST have aria-live="polite" or aria-live="assertive". Apply to: correct-feedback divs, incorrect-feedback divs, skip-note divs, result messages, #feedback, .feedback-message, and any element whose content or visibility changes based on game state. This is required for WCAG Success Criterion 4.1.3 (Status Messages) — screen readers announce live region changes without requiring focus change.
    ...
    Use aria-live="assertive" only for time-critical feedback (e.g. wrong answer that costs a life). Use aria-live="polite" for standard correct/incorrect messages.
